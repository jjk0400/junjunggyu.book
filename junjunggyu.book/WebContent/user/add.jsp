				...
				<form>
					...
					<table class="table">
						<thead>
							<tr>
								<td id="firt">*이름</td>
								<td id="snd"><input name="name" type="text" maxlength="6"
						...
						<tbody>
							<tr>
								<td id="firt">*아이디</td>
								<td id="fon"><input name="id" type="text" minlength="4"
									maxlength="8" placeholder="아이디 입력" 
								<% 	
									if(userId != null){
								%>
									value=<%=userId %>								
								...
								%>	
									required><br>(아이디
									중복 확인 결과 표기)</td>
								<td id="fon" colspan="2">영문 숫자를 조합하여 4~8자 이내로 입력<br>(대소문자
									구별. 한글/특수문자 사용 불가)
								</td>
							</tr>
							<tr>
								...
								<td><input type="password" minlength="8" maxlength="10"
							...
							<tr>
								<td id="firt">*성별</td>
								<td colspan="3"><input type="radio" name="gender" value="남" required>남&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div id="button">
						<input type="submit" value="확인" class="btn btn-default" formaction="action/addaction.jsp"/>
						<a href="../main.jsp" type="button" class="btn btn-default">취소</a>
					</div>
				</form>
			</div>
			<div id="footer">
