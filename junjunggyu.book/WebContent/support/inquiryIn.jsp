...
<%
	...
	int inquiryNum = Integer.parseInt(request.getParameter("num"));
	
	inquiry = inquiryService.getInquiry(inquiryNum);
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<body>
	<div class="container">
		...
		<div>
			...
			<hr>
			<div>
				<p id="left"><%= inquiry.getInquiryTitle() %></h4>
				<p id="h4D"><%= inquiry.getInquiryDate() %></p>
			</div>
			
			<div id="divS">
				<p><%= inquiry.getInquiryContent() %></p>
			</div>
			
			<div>
				<a id="aBack" type="button" class="btn btn-default" href="inquiryMain.jsp">목록으로</a>
			</div>
		</div>
