...
<body>
	<div class="container">
		...
		<div>
			<form action="action/addInquiry.jsp">
			<h3>고객지원 > 1:1문의</h3>
			<hr>
			<h2>글쓰기</h2>
			...
			<div>
				<div>
					...
					<input name="title" type="text" minlength="1" maxlength="50" 
					placeholder="제목을 적어주세요.">
				</div>
				<br>
				<div>
					<span><strong>내용 : </strong></span>
					<textarea name="content" id="inS" class="noresize" 
					maxlength="1500" placeholder="내용을 적어주세요."></textarea>
				</div>
			</div>
			<br><br><br><br><br><br>
			<hr>
			<div>
				<button id="inA" type="submit" class="btn btn-default">작성</button>
			</div>
			</form>
		</div>
