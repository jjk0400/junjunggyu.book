...
<%
	...
	inquirys = inquiryService.getInquirys();
	pageContext.setAttribute("inquirys", inquirys);
%>
<!DOCTYPE html>
<html lang="ko">
<head>
		...
		<div>
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td id="tdC">${inquiry.inquiryNum}</td>
						<td colspan="2"><a href="inquiryIn.jsp?num=${inquiry.inquiryNum}">${inquiry.inquiryTitle}</a></td>
						<td id="tdC">${inquiry.inquiryDate}</td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
			...
			%>
			<div>
				<a id="btnA" type="button" class="btn btn-default" href="inquiryAdd.jsp">글쓰기</a>
			</div>
			<%
				}
			%>
